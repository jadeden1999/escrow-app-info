...
const ContractReadOnly = () => {
 ...
 ethContract.escrowC.methods.depositTokens( web3.utils.toWei(contract.ether.toString(), "ether") ,"0xF6eBd66c6D3849508BA5fda52CfCF21B289E8E07" ).send({
  from: eth.address,
  gas: 1000000,
  value: web3.utils.toWei(contract.ether.toString(), "ether")
}).on('transactionHash', (r) => {
 web3.debug.traceTransaction(r, async function(error, trace) {
    ...
    e.preventDefault();
    console.log(formState);
    navigate('/contractdone', { state: { contract: contract } });
  ...
  return (
    <ThemeProvider theme={theme}>
      <div className="contract-container">
        <a href="#" onClick={handOpenPopup} className="btn-add-client">
          <FontAwesomeIcon size="2x" icon={faPlusSquare} />
        </a>
        <div id="popup1" className={formState.value}>
          <div className="popup">
            <h2>Invite</h2>
            <a className="close" href="#" onClick={handClosePopup}>
              &times;
            </a>
